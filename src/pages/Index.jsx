...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[url('/path/to/your/image.jpg')] bg-cover bg-center bg-fixed">
      <div className="w-full max-w-6xl p-8 bg-black bg-opacity-50">
